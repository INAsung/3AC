...
// spout setting
const int initial_central_spout = 4;  // index from zero
  ...
  switch (status) {
    ...
    case 16:
      {  // #8-01. choose next trial's central spout
        ...
        central_picked = central_valve_select(central_choices);
        central_picked_pin = central_picked + 16;
        if (central_picked != central_picked_prev) {
